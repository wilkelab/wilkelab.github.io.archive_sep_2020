...
```
  ...
  **b. (15 points)** Discuss the information (overarching trends, patterns, etc.) your final plot reveals. Be sure to include in your discussion the similarities/differences among countries and a clear, logical justification for why you selected the particular geom(s) used to represent this data. In addition, your final data-frame (and hence plot) should contain some missing values (represented as NA). Explain why these values are missing. Please limit your full response to a maximum of 7 sentences.
