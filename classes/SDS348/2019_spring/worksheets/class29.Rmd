...
Using the data frame `US_counties_income`, plot all the counties of the lower 48, coloring each one by median income. Hint: Use `scale_fill_viridis_c(option = "B")` to create an appealing color effect.
