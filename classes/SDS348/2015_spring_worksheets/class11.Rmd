...
*If we define a call of virginica as a positive and a call of versicolor as a negative, what are the true positive rate (sensitivity, true positives divided by all positives) and the true negative rate (specificity, true negatives divided by all negatives) in your analysis?*
```{r}
# R code goes here.
```
